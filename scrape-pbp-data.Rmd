...
# write_ods(x = roster_data, 
#          path = "./Outputs/nba_2024_roster_finals_data.ods", 
#          na_as_string = FALSE)

datatable(roster_data)
...
team_names <- map(
 ...
 datatable(pbp_finals_data)
 
 # write_ods(x = pbp_finals_data, 
